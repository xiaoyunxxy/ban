...
def get_arguments():
    ...
    parser.add_argument("--data_root", type=str, default="/vol/tensusers2/xxu/data/")
    ...
    parser.add_argument("--victim_label", type=int, default=1)
    parser.add_argument("--attack_mode", type=str, default="SSDT")
