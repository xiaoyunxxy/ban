...
from train_models.IAD.config import get_arguments
from train_models.IAD.dataloader import get_dataloader
from train_models.IAD.utils import progress_bar
...
def eval(netC, netG, netM, test_dl1, test_dl2, opt):
    ...
    for batch_idx, (inputs, targets), (inputs2, targets2) in zip(range(len(test_dl1)), test_dl1, test_dl2):
        ...
        acc_clean = total_correct_clean / total_sample
        ...
        acc_bd = total_correct_bd / total_sample
